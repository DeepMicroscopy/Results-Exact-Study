...
fake_path = "Results/Mitosen/FirstRound/GT/fakeMitoticFigures.json"
group_0 = []
group_1 = []
group_2 = []
...
with open('Results//Mitosen//FirstRound/GT//FakeMitoticFigures_G0.txt', 'w') as f:
    f.writelines(group_0)

with open('Results//Mitosen//FirstRound/GT//FakeMitoticFigures_G1.txt', 'w') as f:
    f.writelines(group_1)

with open('Results//Mitosen//FirstRound/GT//FakeMitoticFigures_G2.txt', 'w') as f:
